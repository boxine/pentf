...
async function run() {
    ...
    assert.strictEqual(
        linkify('As reported on https://boxine.atlassian.net/browse/TOC-1234 , <URL> (for URL=http://localhost:3000/?foo=bar&baz=9 )'),
...
module.exports = {
    description: 'Testing the integration test framework itself: Create links for URLs embedded in text',
    run,
};
